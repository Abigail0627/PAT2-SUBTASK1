...
3.How The Morse Code System Works: dots and dashes?
the system uses 3 basic timing rules:
1. **Dot duration** is the basic unitof time. A dot= 1 unit.
2. **Dash duration** = 3 units or 3x the length of a dot.
3. **Spacing**
...
4. References
   ...
   2.Burns, R. W.(2004). *Communications: An International History of the formative years*.IET.
   3.Morse Code Translator. https://morsecode.world/international/.morse.html
